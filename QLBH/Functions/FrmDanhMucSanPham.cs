            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand(queryString, connection))
                {
                    try
                    {
                        ...
                        databaseQuanLyBanHangDataSet.products.Clear();
                        adapter.Fill(databaseQuanLyBanHangDataSet.products);

                        // Hiển thị dữ liệu
                        //productsBindingSource.DataSource = null;
                        productsBindingSource.DataSource = databaseQuanLyBanHangDataSet.products;
                        dgvSanPham.Refresh();
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand command = new SqlCommand(queryString, connection))
                {
                    try
                    {
                        ...
                        databaseQuanLyBanHangDataSet.Reset();
                        databaseQuanLyBanHangDataSet.products.Clear();
                        databaseQuanLyBanHangDataSet.products.AcceptChanges();
